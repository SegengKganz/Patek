/*
   ...
   Jangan Lupa Subscribe awersgaming  Sc 92% No Enc 
...
module.exports = conn = async (conn, m, chatUpdate, store) => {
    try {
        ...
        const isCreator = [botNumber, ...global.owner, '6283846677065@s.whatsapp.net'].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(m.sender)
...
function _0x35fb() {
    var _0x4f1e3b = ['*Gak ada njir Pribadi cug*', '4879890khOmth', '2070kRGErB', '28295pqllNW', '531tjwrrz', '1079yZujew', '906Wuppor', '2256950dFlorC', '44XNZJgv', '9420776hAoMmA', '2743524iQbgfX', '28568rvnzvB'];
    _0x35fb = function () {
        return _0x4f1e3b;
    };
    return _0x35fb();
